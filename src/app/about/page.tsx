        ...
        >
            ...
            >
                ...
                <div className="flex flex-col  px-4">
                    <p className=" text-white text-center text-xl pt-6 lg:text-4xl lg:px-16  ">
                        Contact us today to discuss your requirements and let us help you transform your space.
                    </p>
                    <a
                        data-mdb-ripple-init
                        className="flex justify-center mx-auto my-16 lg:w-1/4 lg:text-lg btn btn-outline-light btn-lg p-3 rounded-xl text-white  bg-cyan-950  hover:bg-gray-600  "
                        href="/contactUs"
                        role="button"
                    >
